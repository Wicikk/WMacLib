...
function WMacLib:Window(Settings)
	...
	function WindowFunctions:TabGroup()
		...
		function SectionFunctions:Tab(Settings)
			...
			contentRowUIListLayout.Padding = UDim.new(0, 6)
			...
			contentColumnLeft.Size = UDim2.new(0.5, -3, 0, 0)
			...
			contentColumnRight.Size = UDim2.new(0.5, -3, 0, 0)
			...
			local RESPONSIVE_THRESHOLD = 820
			local rightSections = {}
